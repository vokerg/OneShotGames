...
- No navigation, simulation-phase, balance redesign, new mission, final art, voice, or sibling-game files are changed.
- Mission hero arrays are migrated and deduplicated deterministically.
...
- full assembled verifier, including 800 Node tests: passed;
- dedicated runtime-content reconciliation verifier: passed;
