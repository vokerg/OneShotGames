...
export const VERIFICATION_COMMANDS = Object.freeze([
  ...
  Object.freeze({ id: 'command-card', label: 'production command card', script: 'scripts/verify-command-card.mjs' }),
  ...
  Object.freeze({ id: 'release-provenance', label: 'complete release provenance manifest', script: 'scripts/verify-release-provenance.mjs' }),
  Object.freeze({
