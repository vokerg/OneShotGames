(() => {
  ...
  sceneContext.translate = (x, y) => {
    // The game applies screen shake before uploading its CPU-rendered floor frame.
    // putImageData ignores transforms, so applying that translation to later layers
    // tears the scene apart. Capture the initial shake and apply it once when the
    // completed off-screen frame is presented instead.
  ...
  // Present the synchronous title-screen render once game.js has finished loading.
